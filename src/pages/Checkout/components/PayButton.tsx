...
export const PayButton = forwardRef(function PayButton(
  ...
  return (
    <label
      ...
      className="flex w-full p-4 text-[12px] uppercase items-center gap-3 text-gray-700 rounded-md bg-gray-400 hover:bg-gray-500 data-[state='true']:bg-purple-100 data-[state='true']:ring-1 data-[state='true']:ring-purple-200"
    >
